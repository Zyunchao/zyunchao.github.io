import{_ as n,p as s,q as e,a1 as i}from"./framework-d7d41868.js";const a="/images/realize/基座应用目录.png",l="/images/realize/微应用目录.png",c={},m=i(`<h1 id="框架结构" tabindex="-1"><a class="header-anchor" href="#框架结构" aria-hidden="true">#</a> 框架结构</h1><h2 id="基座应用" tabindex="-1"><a class="header-anchor" href="#基座应用" aria-hidden="true">#</a> 基座应用</h2><p>目录树</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>├── README.md 
