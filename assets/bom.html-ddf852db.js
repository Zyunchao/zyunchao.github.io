import{_ as n,p as s,q as a,a1 as e}from"./framework-d7d41868.js";const t={},p=e(`<h1 id="bom" tabindex="-1"><a class="header-anchor" href="#bom" aria-hidden="true">#</a> Bom</h1><p>一些关于浏览器 bom 的方法</p><h2 id="geturlparams" tabindex="-1"><a class="header-anchor" href="#geturlparams" aria-hidden="true">#</a> getUrlParams</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token doc-comment comment">/**
 * 获取 url 中的参数，并转换为对象
