import{_ as n,p as s,q as a,a1 as e}from"./framework-7d8e42ec.js";const p="/element-component/assets/theme-dir-20a62b04.png",t={},c=e('<h1 id="主题" tabindex="-1"><a class="header-anchor" href="#主题" aria-hidden="true">#</a> 主题</h1><p>系统后续会接入换肤功能，需要在开发时，注意 css 变量的使用</p><p>系统的 css 变量存放于基座应用下 <code>/src/assets/theme</code> 目录</p><p><img src="'+p+`" alt="them-dir"></p><h2 id="目前已经添加公用-css-变量" tabindex="-1"><a class="header-anchor" href="#目前已经添加公用-css-变量" aria-hidden="true">#</a> 目前已经添加公用 css 变量</h2><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">:root </span><span class="token punctuation">{</span>
